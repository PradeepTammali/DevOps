...
import (
	...
	pradeepv1alpha1 "pradeep/k8s/io/api/v1alpha1"
...
// +kubebuilder:rbac:groups=pradeep.k8s.io,resources=maprtickets,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=pradeep.k8s.io,resources=maprtickets/status,verbs=get;update;patch
...
func (r *MapRTicketReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	...
	*/
	...
	var maprTicket pradeepv1alpha1.MapRTicket
	...
	maprTicket.Status.Phase = pradeepv1alpha1.Available
	...
	createMapRTicketSecret := func(ticketstring string, maprticket *pradeepv1alpha1.MapRTicket) (*apiv1.Secret, error) {
	...
	createMapRTicket := func(maprticket *pradeepv1alpha1.MapRTicket) (*apiv1.Secret, error) {
...
var (
	...
	apiGVStr    = pradeepv1alpha1.GroupVersion.String()
)
*/
...
func (r *MapRTicketReconciler) SetupWithManager(mgr ctrl.Manager) error {
	...
	*/
	return ctrl.NewControllerManagedBy(mgr).
		For(&pradeepv1alpha1.MapRTicket{}).
		Owns(&apiv1.Secret{}).
		Complete(r)
}
